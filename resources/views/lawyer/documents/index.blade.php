                ...
                <div class="p-6 text-gray-900">
                                    ...
                                    @foreach($documents as $document)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="{{ route('lawyer.documents.show', $document->id) }}" class="text-blue-600 hover:text-blue-900">View</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">You don't have any documents yet.</p>
                        </div>
                    @endif
                </div>
            </div>
