    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center mb-16">
                <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Our Story</h2>
                ...
                <div class="mt-8 max-w-3xl lg:mx-auto">
            ...
            <div class="mb-16">
                <h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl text-center mb-8">Our Team</h2>
                        ...
                        @foreach($team as $member)
                            <div class="text-center">
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="text-sm font-medium text-blue-600">{{ $member->title }}</p>
                ...
                @else
                    <div class="text-center py-8">
                        <p class="text-gray-500">Team information coming soon!</p>
                    </div>
                @endif
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        ...
                        <h3 class="mt-3 text-lg font-medium text-gray-900">Quality Assurance</h3>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-3 text-lg font-medium text-gray-900">Timely Service</h3>
                        <p class="mt-2 text-sm text-gray-500">
                            We respect your time and adhere to agreed-upon schedules for all projects.
                        </p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="mt-3 text-lg font-medium text-gray-900">Expert Team</h3>
                        <p class="mt-2 text-sm text-gray-500">
                            Our professionals are experienced, licensed, and continuously trained in their fields.
                        </p>
                    </div>
                </div>
            </div>
